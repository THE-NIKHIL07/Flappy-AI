...
class FlappyBirdEnv(gym.Env):
    def __init__(self, render_mode=None, frame_skip=1):
        ...
        self.bird_path = "assets/bird.png"
    ...
    def _init_display(self):
        if self.screen is None:
            ...
            self.flap_sound = pygame.mixer.Sound("assets/flap.mp3")
            self.score_sound = pygame.mixer.Sound("assets/score.mp3")
            self.die_sound = pygame.mixer.Sound("assets/die.mp3")
    ...
    def step(self, action):
        ...
        for _ in range(self.frame_skip):
            if action == 1:
                self.bird_vel = -7
                self.flap_sound and self.flap_sound.play()
            ...
            if not self.passed_pipe and self.pipe_x + 52 < 50:
                ...
                self.score_sound and self.score_sound.play()
            ...
            if self.bird_y < 0 or self.bird_y > 400 or (
                50 + self.collision_w > self.pipe_x and
                50 < self.pipe_x + 52 and
                (self.bird_y < self.pipe_y or self.bird_y + self.collision_h > self.pipe_y + 130)
            ):
                reward = -1.0
                done = True
                self.die_sound and self.die_sound.play()
    ...
    def _get_state(self):
        ...
        return [
            ...
            (self.pipe_y + 130 - self.bird_y) / self.height,
    ...
    def render(self, best_score=0):
        ...
        pygame.draw.rect(self.screen, (0, 200, 0), (self.pipe_x, self.pipe_y + 130, 52, 512))
